...
return <<<HTML
  ...
  <tr>
   ...
   <td class='row4 bottommenu' width='99%'><div align='left' style='float:left;width:auto;padding-top:4px;padding-bottom:4px;'><strong>{$ibforums->lang['event_date']} {$event['mday']} {$event['month_text']} {$event['year']}</strong> $date_ends ($type)</div>$edit_button</td>
  </tr>
  <tr>
   <td valign='top' class='row1 avatar' nowrap='nowrap'>{$member['avatar']}<span class='postdetails'><br />{$ibforums->lang['group']} {$member['g_title']}<br />{$ibforums->lang['posts']} {$member['posts']}<br />{$ibforums->lang['joined']} {$member['joined']}</span></td>
