...
function bot_antispam($regid) {
    ...
    // Build the SVG to match Screenshot 2026-05-02 173459.png
    $svg_content = "";
    $chars = str_split($equation);
    $x = 20;
    ...
    <tr>
      <td class='row1' width='40%' valign='top'>
        <div style="font-size:12px; line-height:1.4;">
            ...
            Enter the solution to the problem<br />
            displayed as an<br />
            image.
        </div>
        <br />
        <input type='text' size='32' maxlength='32' name='reg_code' class='forminput' style="border:1px solid #4b75b3;" />
      </td>
      <td class='row1' align='center' valign='middle'>
        <input type='hidden' name='regid' value='$regid' />
        $svg
        <!-- HoneyPot to trap bots -->
        <div style="position:absolute; left:-5000px;"><input type="text" name="mid_name_val" value=""></div>
      </td>
    </tr>
  </table>
</div>
...
function bot_antispam_gd($regid) {
    // Just point to the main function so both styles use the math captcha
    return bot_antispam($regid);
}
