...
<br>
<div class="tableborder">
<div class="titlemedium">{$ibforums->lang['quick_pm_title']}</div>
...
<input type='hidden' name='entered_name' value='{$data['member']['name']}'/>
<input type='hidden' name='carbon_copy' value=''/>
<input type='hidden' name='msg_title' value='Re: {$data['msg']['title']}'/>
<table class="pformright" width='100%' cellpadding='3' cellspacing='1'>
<tr>
<td width='20%' valign='top'><b>{$ibforums->lang['y_reply']}</b></td>
<td width='100%' valign='top'><textarea rows='7' cols='50' name='Post'></textarea>
</tr>
<tr>
<td colspan='2' class='pformstrip'>{$ibforums->lang['qpm_opt']}</td>
</tr>
<tr>
<td class="pformright" colspan="2">
<input type='checkbox' name='add_sent' value='no'/>&nbsp;<b>{$ibforums->lang['auto_sent_add']}</b>
<br /><input type='checkbox' name='add_tracking' value='1' />&nbsp;<b>{$ibforums->lang['vm_track_msg']}</b>
</td>
</tr>
<tr>
<td class="darkrow3" align='center' colspan='2'><input type='submit' value='{$ibforums->lang['submit_send']}' class='forminput' name='submit'></td>
</tr>
</table></div><br></form>
