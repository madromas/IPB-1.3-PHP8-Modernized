...
'personal_ops_txt'      => "this is where you can modify your personal information to allow others to find out a little more about you.",
...
'avatar_click'          => "Click on one of the avatars in this list to add it into the box.",
'location'              => "<b>Your Location</b>",
'avatar_url_ext'        => "The following file types are allowed: ",
'email_address'         => "Your registered email address",
'pm_reminder'           => "<b>Send a confirmation email when I receive a new private message</b>",
'subs_last_post'        => "Last Post",
'email'                 => "Email Settings",
'account_email_submit'  => "Change my Email Address",
'settings'              => "Account Options",
'photo'                 => "<b>You may enter a URL for a personal photograph</b>",
'js_so_far'             => "characters so far",
'email_help'            => "This is where you can change your email settings",
'settings_dopopup'      => "Do you wish to get a pop up notification?",
'settings_display'      => "Board Display Settings",
'settings_skin_txt'     => "You may choose a 'skin' to use.",
'send_full_msg'         => "<b>Include a copy of the post when emailing me</b>",
