...
'cat_not_found'			=> "The specified category could not be found",
'no_files_cat'			=> "There are no files in this category",
'no_perm'				=> "You do not have permission to use this feature",
'no_file'				=> "The specified file could not be found!",
'no_download'			=> "DOWNLOAD COULD NOT BE FOUND!",
'd_failure'			=> "File Transfer Failed.",
'download_no_perm'		=> "The group you are in is not allowed to download files!",
'file_name_empty'			=> "The file name was left empty. Please click your browser's back button and fill in the form completely.",
'file_screen_empty'		=> "You must choose a screenshot to upload with your file.  Pleae hit your browser's back button and choose one.",
'no_guests'			=> "Sorry, but guests are not allowed to use this feature.",
'file_cat_empty'			=> "The category was left empty or an invalid category was selected. Please click your browser's back button and fill in the form completely.",
'file_desc_empty'			=> "The description field was left empty. Please click your browser's back button and fill in the form completely.",
'screen_upload_too_big' => "The screenshot file is too big! The maximum size allowed is " . ($ibforums->vars['d_screen_max_dwnld_size'] ?? 0),
'ext_error'			=> "The file type you tried to upload is not allowed!",
'screen_upload_error'		=> "Screenshot could not be uploaded!",
'screen_not_allowed'		=> "Sorry, screenshots are not allowed!",
'upload_file_empty'		=> "The upload field was empty. Please go back and specify a file to upload.",
'file_upload_big' => "The file specified is too large to upload! The maximum size allowed is " . ($ibforums->vars['d_max_dwnld_size'] ?? 0),
'd_section_close'			=> "Sorry! The download section is closed for maintainance!",
'file_upload_error'		=> "The file could not be uploaded!",
'no_dwnld_mem'			=> "Our database shows that you have not submitted this file!",
'none_dwnld_mem'			=> "Our database shows that you have not submitted any files!",
'no_id'				=> "No ID was specified!",
'd_no_search_field'		=> "No search field was filled in! Please click you browser's back button and fill in at least one of the fields.",
'd_no_search_result'		=> "We could not find any files matching your criteria!",
'no_idname'			=> "Either specify the name or the id!",
'no_accept'			=> "There are no files waiting to be accepted!",
'already_rated'			=> "You have already rated this download",
'n_unlink'				=> "File cannot be removed.",
'too_many_dls'			=> "You may not download any more files until 24 hours has passed.",

'invalid_chars' => "Sorry, only letters and numbers are permittable characters in usernames.<br /><br /> Please hit the back button and try again.",
...
'subs_no_upgrade' => "This payment method does not support upgrades. This process cannot continue.",
