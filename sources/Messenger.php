...
class Messenger {
    ...
    function __construct() {
    	...
    	{
    		$this->msg_stats['vdirs'] = "in:Inbox|sent:Sent";
    	}
...
{
    // Added $ibforums to the global list here
    ...
    if ( $DB->get_num_rows() )
    {
        // Now $ibforums->lang['other'] will work correctly
    ...
    {
        // Now $ibforums->lang['address_list_empty'] will work correctly
