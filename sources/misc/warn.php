...
class  warn {
    ...
    function __construct()
    {
		...
		if ( !is_array($this->nav) || count($this->nav) < 1 )
		{
		...
		if (! isset($this->page_title) || ! $this->page_title )
{
	...
	function view_log()
	{
		...
		$print->pop_up_window( "ÐÅÉÒÈÍÃ", $this->output );
	...
	function do_warn()
	{
		...
		$save['wlog_contact_content'] = isset($save['wlog_contact_content']) ? $save['wlog_contact_content'] : '';
