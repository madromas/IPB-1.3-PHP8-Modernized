...
// Проверяем, существует ли ключ и является ли он массивом/счетным объектом
if ( isset($this->children[ $forum['id'] ]) && is_array($this->children[ $forum['id'] ]) && count($this->children[ $forum['id'] ]) > 0 )
{
