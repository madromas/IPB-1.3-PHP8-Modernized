...
class admin_skin {
	...
	function start_table( $title="", $desc="") {
		...
		if (isset($this->td_header[0]))
		{
			...
			if ( is_array($this->td_header) && ($this->td_header[0][0] ?? '') == '&nbsp;' && ($this->td_header[1][0] ?? '') == '&nbsp;' && ( ! isset( $this->td_header[2][0] ) ) )
			{
	...
	function get_css()
	{
		...
		@import url('https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap');
					...
					#submenu   { border:1px solid #BCD0ED;background-color: #DFE6EF;font-size:13px;margin:3px 0px 3px 0px;color:#3A4F6C;font-weight:bold;}
					...
					.offdiv { font-size:13px;font-weight:bold }
					
					form { display:inline }

					input { vertical-align:middle; border-radius:.5em; font-family: 'Nunito', sans-serif;padding: 0.3rem 0.5rem;
    border: 1px inset #BCD0ED; }
					
					img  { vertical-align:middle }
					
					.titlemedium { border:1px solid #FFF; font-weight:bold; color:#3A4F6C; padding:7px 0px 7px 2px; background:#d4e2f5; }
					...
					#normal      { font: 13px; color:#333333 }
					
					#detail { font-size:11px; color: #333333 }
					
					#subtitle { font-size:16px; color:#FF9900; font-weight:bold }
					#smalltitle { font-size:11px; color:#FF9900; font-weight:bold }
					...
					.copy { color:#000; font-size:13px; border-top:1px solid #000; margin-bottom:13px; padding:6px;  margin-left:auto;margin-right:auto; text-align:center; }
					
					#nav { color:#000000; font-size:11px }
					
					#description { color:#000000; font-size:13px }
    ...
    border: 1px solid #bbb;}
					...
					.fauxbutton a:link, .fauxbutton  a:visited, .fauxbutton  a:active { font-size:13px;font-weight:bold; }
					
					.textinput { background-color: #FFF; color:#000; font-size:13px;  padding:2px; border:1px inset #BCD0ED; }
    ...
    border: 1px solid #bbb;
					...
					#jwrap { border:1px solid #BCD0ED;background-color: #DFE6EF;font-size:13px;margin:3px 0px 3px 0px;color:#3A4F6C;font-weight:bold;padding:8px }
	...
	function print_top($title="",$desc="") {
		...
		return "<html>
				 ...
				 <body marginheight='0' marginwidth='0' leftmargin='0' topmargin='0' bgcolor='#FFFFFF' {$top_extra_val}>
	...
	//{ background-color:#C2CFDF; font-weight:bold; font-size:13px; color:#000055 }
    ...
    TABLE, TR, TD { font-size: 12px; color:#000; font-family: Nunito, sans-serif; }
    
    INPUT {vertical-align:middle;font-family: 'Nunito';padding: 2px;
    border: 1px inset #BCD0ED;}
    ...
    #title a:link, #title a:visited, #title a:active { text-decoration: none; color: #FFF; }
    ...
    .tableborder { border: 1px solid #345487; background-color: #FFF; border-radius:3px}
    ...
    .cattitle a:link, .cattitle a:visited, .cattitle a:active {text-decoration:none; color: #fff; }
</style>
				  $pop_win
				  </head>
				 <body marginheight='0' marginwidth='0' leftmargin='0' topmargin='0' bgcolor='#FFF'>
				 <div align='center' class='admin-logo'>Admin Panel</div>
