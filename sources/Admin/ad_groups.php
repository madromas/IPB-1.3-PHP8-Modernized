...
class ad_groups {
	...
	function save_group($type='edit')
	{
		...
		$db_string = array(
							 ...
							 'g_invite_friend' => intval($IN['g_invite_friend']),
							 ...
							 'g_can_remove'    => intval($IN['g_can_remove']),
							...
							'g_attach_max'     => intval($IN['g_attach_max']),
    'g_avatar_upload'  => intval($IN['g_avatar_upload']),
    'g_calendar_post'  => intval($IN['g_calendar_post']),
    'g_max_messages'   => intval($IN['g_max_messages']),
    'g_max_mass_pm'    => intval($IN['g_max_mass_pm']),
    'g_search_flood'   => intval($IN['g_search_flood']),
							 'prefix'               => $prefix,
							 'suffix'               => $suffix,
