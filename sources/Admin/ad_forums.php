...
$ADMIN->html .= $SKIN->add_td_row( array( 
    "<b>Forum Icon</b><br>Located at /html/icons/. (must be in .gif format)", 
...
$ADMIN->html .= $SKIN->add_td_row( array( "<b>Forum Icon</b><br>Located at /html/icons/. (must be in .gif format)" , $SKIN->form_dropdown( "icon", $icons, $forum['icon'] )
) );
